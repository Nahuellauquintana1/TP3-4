...
{
    FILE* pFile;
    pFile = fopen("C:\Users\alumno\Desktop\TP3\Win_64\data.csv", "r");
    parser_eEmpleadoFromText(pFile,pArrayListeEmpleado);
    return 1;
}
...
{
    FILE* pFile;
    pFile = fopen("C:\Users\alumno\Desktop\TP3\Win_64\data.csv", "rb");
    return 1;
}
...
{
    ll_sort(pArrayListeEmpleado,ordenarNombres,1);
    return 1;
}
...
int ordenarNombres (empleado1*, empleado2*)
{
    eEmpleado* aux1 = empleado1;
    eEmpleado* aux2 = empleado2;
